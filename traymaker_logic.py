...
class TrayLaserCut():
    ...
    def draw(self, pieces, thickness, sort_pieces=False, tray_number=None, max_width=420):
        error = ""

        all_directives = []
        cumul_y_piece_offset = 0

        filtered_pieces = list(filter(lambda piece: str(piece["thickness"]) == str(thickness), pieces))
